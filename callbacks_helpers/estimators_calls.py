...
def retrieve_systems_with_companion_mass(systems_db, masses_folder_path, systems_path):
    dfs_with_masses = []
...
if __name__ == '__main__':
    systems_db_path = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, "systems_database"))
    systems_db = db_calls.inspect_db(systems_db_path)
    
    masses_data = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, "masses_data"))
    dfs = retrieve_systems_with_companion_mass(systems_db, masses_data, systems_db_path)
